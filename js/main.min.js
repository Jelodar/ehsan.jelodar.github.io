$(document).ready(function() {
    ...
    $(document).on('mousedown', '.project-item-modal-link', function() {
        ...
        $.get('/' + id + '.json').done(function(data) {
            ...
            var item_download_btn_text = obj.downloadBtnText;
            ...
            var isMi3Item = (id == 44 || id == "44") || (id == 45 || id == "45");
            if(isMi3Item)           
            { 
                var download_text =  item_download_btn_text != undefined ? item_download_btn_text : "Download (Version: 4.0.11)";
                 item_link_container = "<div id='project-dialog-link-container'><a class='btn-link' target='_blank' href='" + item_link + "'>"+download_text+"</a></div>";
            }
            ...
            if(isMi3Item)           
            { 
                 $("#project-item-dialog-explain").css('direction', 'rtl');
            }
        }).fail(function() {
